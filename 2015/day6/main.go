...
func s2i(i string) int {
	r, _ := strconv.ParseInt(i, 10, 32)
	return int(r)
}
...
func part1() {
	...
	for _, row := range rows {
		m := regex.FindStringSubmatch(row)
